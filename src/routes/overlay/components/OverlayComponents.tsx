...
export const OverlayButton = ({
  ...
  >
    <button
      className={`${
        draggable ? "" : ""
      } h-full bg-transparent   outline-none  active:outline-2 active:outline-surface group-hover:dark:text-white dark:text-stone-400  flex items-center justify-center aspect-square shrink-0 rounded-sm transition-all duration-100   ${
        active
